...
//{
//    std::vector<std::vector<float>> points(N, std::vector<float>(2)); // Store coordinates of N points
...
//    std::vector<std::vector<float>> points(sides, std::vector<float>(2)); // Store coordinates of sides points
//
...
//}
//
//int lab2_task2_main(int argc, char **argv)
//{
//    glutInit(&argc, argv);
