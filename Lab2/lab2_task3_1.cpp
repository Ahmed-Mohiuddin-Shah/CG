...
//}
//
//// Function to draw parallel lines using DDA and Bresenham
//void drawParallelLines(int x1, int y1, int x2, int y2, int spacing)
//{
...
//    int bl_time = calculateExecutionTime(drawLineBL, x1, y1 + spacing, x2, y2 + spacing);
//    std::cout << "BL Time: " << bl_time << "ms\n";
//}
//
//void display()
//{
...
//
//    drawParallelLines(100, 200, 400, 350, 20);
//}
//
//int lab2_task3_1_main(int argc, char **argv)
//{
//    glutInit(&argc, argv);
//    glutInitDisplayMode(GLUT_SINGLE | GLUT_RGB);
//    glutInitWindowSize(700, 700); // Here we set the window size
//    glutCreateWindow("Task 3.1");
